...
package com.qianseit.westore.ui.fall;
...
//        }
    ...
    private void init(Context context) {
        ...
        //useThumbDrawable(context, res.getDrawable(R.drawable.test));

        mOverlayDrawable = res.getDrawable(R.drawable.default_img_square);//TODO:����ͼƬ
