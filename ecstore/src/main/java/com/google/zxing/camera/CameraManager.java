...
//            framingRect = new Rect(90, 300, 630,940);
			int left = (int) (screenResolution.x * 0.125);
			int top = (int) (screenResolution.y * 0.2);
			int right = (int) (screenResolution.x * 0.75 + left);
			int bottom = (int) (screenResolution.y * 0.5 + top);
